...
// Chuẩn hóa dữ liệu xe nhận từ form trước khi kiểm tra và lưu.
...
// Chỉ cho phép dữ liệu hợp lệ đi xuống model và database.
function validateCar(car) {
    if (!car.name || !car.brand || !car.image) {
        return "Vui lòng nhập đầy đủ tên xe, hãng và link ảnh"
    }

    if (car.name.length > 100 || car.brand.length > 100 || car.image.length > 255) {
...
// Hiển thị trang lỗi khi admin thao tác với xe không tồn tại.
